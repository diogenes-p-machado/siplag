...
var $author$project$Main$Model = F9(
	function (url, menu, modo, schema, tabela, showMenu, formJson, subFormJson, listJson) {
		return {formJson: formJson, listJson: listJson, menu: menu, modo: modo, schema: schema, showMenu: showMenu, subFormJson: subFormJson, tabela: tabela, url: url};
	});
...
var $author$project$Main$subItemDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$SubItem,
	A2($elm$json$Json$Decode$field, 'label', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'link', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'selecionado', $elm$json$Json$Decode$int));
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A9($author$project$Main$Model, $elm$core$Maybe$Nothing, _List_Nil, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, true, $elm$core$Dict$empty, $elm$core$Dict$empty, _List_Nil),
...
var $author$project$Urls$Recurso = function (a) {
	return {$: 'Recurso', a: a};
};
...
var $author$project$Main$campoDecoder = A2(
...
var $author$project$Urls$IdRecurso = F2(
	function (a, b) {
		return {$: 'IdRecurso', a: a, b: b};
	});
var $author$project$Urls$pop = function (url) {
	_v0$2:
	while (true) {
		if (url.$ === 'Just') {
			switch (url.a.$) {
				case 'SubRecurso':
					...
					var id = _v1.b;
					return $elm$core$Maybe$Just(
						A2($author$project$Urls$IdRecurso, recuso, id));
				case 'IdRecurso':
					var _v2 = url.a;
					var recurso = _v2.a;
					return $elm$core$Maybe$Just(
						$author$project$Urls$Recurso(recurso));
				default:
					break _v0$2;
			}
		} else {
...
var $author$project$Urls$SubRecurso = F3(
	function (a, b, c) {
		return {$: 'SubRecurso', a: a, b: b, c: c};
	});
var $author$project$Urls$push = F2(
	function (url, str) {
		_v0$2:
		while (true) {
			if (url.$ === 'Just') {
				switch (url.a.$) {
					case 'Recurso':
						var recurso = url.a.a;
						return $elm$core$Maybe$Just(
							A2($author$project$Urls$IdRecurso, recurso, str));
					case 'IdRecurso':
						var _v1 = url.a;
						var recurso = _v1.a;
						var id = _v1.b;
						return $elm$core$Maybe$Just(
							A3($author$project$Urls$SubRecurso, recurso, id, str));
					default:
						break _v0$2;
				}
			} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								url: $elm$core$Maybe$Just(
									$author$project$Urls$Recurso(
										'/' + (A2(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							url: _Utils_eq(dicionario, model.formJson) ? A2(
								$author$project$Urls$push,
								model.url,
								A2(
									$elm$core$Maybe$withDefault,
									'',
									A2($elm$core$Dict$get, 'id', dicionario))) : $author$project$Urls$pop(model.url)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
	...
	function (campo, model) {
		if (campo.$ === 'Texto') {
			...
			return _Debug_todo(
				'Main',
				{
					start: {line: 659, column: 13},
					end: {line: 659, column: 23}
...
var $author$project$Main$tabela = function (model) {
	...
	if (_v0.$ === 'Just') {
		...
		return $elm$html$Html$text('A implementar');
	}
};
...
var $author$project$Main$topo = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Main$class('flex justify-between')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$author$project$Main$class('p-1 mx-3 inline-flex items-center')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$author$project$Main$class('fas fa-bars pr-2 text-white')
								]),
							_List_Nil),
							A2(
							$elm$html$Html$h1,
							_List_fromArray(
								[
									$author$project$Main$class('text-white p-2')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Siplag')
								]))
						]))
				]))
		]));
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$class('mx-auto bg-grey-400')
			]),
		_List_fromArray(
			[
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$Main$tabela(model)
											]))
									]))
							])),
