...
var $author$project$Main$campoDecoder = A2(
	...
	A2($elm$json$Json$Decode$field, 'tipo', $elm$json$Json$Decode$string));
var $author$project$Main$schemaDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$Schema,
	A2($elm$json$Json$Decode$field, 'tabela', $elm$json$Json$Decode$string),
...
var $author$project$Main$getSchema = function (url) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotSchema, $author$project$Main$schemaDecoder),
			url: url
		});
};
